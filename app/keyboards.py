...
product_list.row(InlineKeyboardButton(text='◀ Пред.', callback_data='previous_apartment'),
                 InlineKeyboardButton(text='Выбрать✅', callback_data='selected_apartment'),
                 InlineKeyboardButton(text='След. ▶', callback_data='next_apartment'),
                 )
pay_list = InlineKeyboardMarkup(row_width=2)
pay_list.row(InlineKeyboardButton(text='-1', callback_data='subtract_days'),
             InlineKeyboardButton(text='💳Оплатить', callback_data='pay'),
             InlineKeyboardButton(text='+1', callback_data='add_days'),
             )
